...
namespace DAL
{
    public class HisMqttError
    {
        public bool Add(DataModel.HisMqttError model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into \"HisMqttError\"(");
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM \"HisMqttError\" ");
            if (strWhere.Trim() != "")
            {
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from \"HisMqttError\" ");
