...
namespace DAL
{
    public class OQC_TraceCache
    {
        public bool Add(DataModel.OQC_TraceCache model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into \"HisTraceCache\"(");
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM \"HisTraceCache\" ");
            if (strWhere.Trim() != "")
            {
        ...
        public bool Delete(string SNCode)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from \"HisTraceCache\" ");
