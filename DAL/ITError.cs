...
namespace DAL
{
    ...
    {
        public bool Add(DataModel.ITError model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into \"HisReplyITError\"(");
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM \"HisReplyITError\" ");
            if (strWhere.Trim() != "")
            {
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from \"HisReplyITError\" ");
