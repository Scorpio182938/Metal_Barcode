...
{
    public class KeyenceScan : IScan
    {
        public bool GetBarcodeL(out string scanData)
        {
            ...
            try
            {
                ...
                string sendstring = "+";
                byte[] buf = Encoding.ASCII.GetBytes(sendstring);
                ...
                receStr += Encoding.GetEncoding("Shift_JIS").GetString(receBytes, 0, bytes);
                ...
                if (receStr.Length <= 10)
                {
                    ...
                    //LogNet_Read.WriteInfo("左扫码:" + data_L);
                    return false;
                }
